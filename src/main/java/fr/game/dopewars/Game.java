...
public final class Game implements TraderConstants {
	...
	final static private Product[] products = { new Product("Acid", 1000, 4500), new Product("Cocaine", 15000, 30000),
			new Product("Hashish", 450, 1500), new Product("Heroin", 5000, 14000), new Product("Ecstacy", 10, 60),
			new Product("Smack", 1500, 4500), new Product("Opium", 500, 1300), new Product("Crack", 1000, 3500),
			new Product("Peyote", 100, 700), new Product("Shrooms", 600, 1400), new Product("Speed", 70, 250),
