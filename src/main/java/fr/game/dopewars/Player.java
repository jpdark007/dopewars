...
public class Player implements TraderConstants, Fighter {
	...
	public void sellProduct(Product product, int quantity, long price) throws QuantityOutOfBoundsException {
		if (null == product) {
	 ...
	 */
	public void removeProduct(Product product, int quantity, long price) throws QuantityOutOfBoundsException {
		Map<Long, Integer> tmp;
		if (products.containsKey(product)) {
			tmp = products.get(product);
